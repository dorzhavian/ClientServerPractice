...
/**
 * ════════════════════════════════════════════════════════════════
 *  משימה 1 — MovieController (שכבת ה-HTTP / REST)
 * ════════════════════════════════════════════════════════════════
 *
...
public class MovieController {
    ...
    // ════════════════════════════════════════════════════════════════════════
    // TODO משימה 1ב — POST יצירת סרט חדש
    // ════════════════════════════════════════════════════════════════════════
    /**
    ...
    */
    ...
    // ════════════════════════════════════════════════════════════════════════
    // TODO משימה 1ד — DELETE מחיקת סרט
    // ════════════════════════════════════════════════════════════════════════
    /**
